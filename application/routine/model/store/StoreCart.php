...
class StoreCart extends ModelBasic
{
    ...
    {
        $productInfoField = 'id,image,slider_image,price,keyword,ot_price,vip_price,postage,mer_id,give_integral,cate_id,sales,stock,store_name,store_info,unit_name,is_show,is_del,is_postage,cost';
        ...
        foreach ($list as $k=>$cart){
			...
			$product['hospitalName'] = StoreHospital::getName($product['cate_id']);
