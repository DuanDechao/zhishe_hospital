                    ...
                    <table class="footable table table-striped  table-bordered " data-page-size="20">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                未支付
                                {elseif condition="$vo['paid'] eq 1 && $vo['confirmed'] == 0 && $vo['status'] eq 0 && $vo['refund_status'] eq 0"/}
                                待预约
                                {elseif condition="$vo['paid'] eq 1 && $vo['confirmed'] == 1 && $vo['status'] eq 0 && $vo['refund_status'] eq 0"/}
                                待体检
                            ...
                            <td class="text-right">
                                <span class="input-group-btn js-group-btn" style="min-width: 106px;">
                                    ...
                                    <button class="btn btn-primary btn-xs" type="button" onclick="$eb.createModalFrame('确认预约','{:Url('deliver_goods',array('id'=>$vo['id']))}',{w:400,h:300})"><i class="fa fa-cart-plus"></i> 确认预约</button>
                                    <div class="btn-group">
                                        <button data-toggle="dropdown" class="btn btn-warning btn-xs dropdown-toggle"
                                                aria-expanded="false">操作
                                            <span class="caret"></span>
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a  href="javascript:void(0);" onclick="$eb.createModalFrame('确认预约','{:Url('delivery',array('id'=>$vo['id']))}',{w:400,h:300})">
