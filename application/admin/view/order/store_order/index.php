            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="act">
                        ...
                        {{#  }else if(d._status==8){ }}
                        <button class="btn btn-primary btn-xs" type="button" onclick="$eb.createModalFrame('确认预约','{:Url('confirm_goods')}?id={{d.id}}',{w:400,h:300})">
                            <i class="fa fa-cart-plus"></i> 确认预约</button>
                        <button type="button" class="layui-btn layui-btn-xs" onclick="dropdown(this)">操作 <span class="caret"></span></button>
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            <li>
                                <a href="javascript:void(0);" onclick="$eb.createModalFrame('{{d.nickname}}-订单详情','{:Url('order_info')}?oid={{d.id}}')">
                        ...
                        {{#  }else if(d._status==2){ }}
                        <button class="btn btn-primary btn-xs" type="button" onclick="$eb.createModalFrame('发报告单','{:Url('deliver_goods')}?id={{d.id}}',{w:400,h:300})">
                            <i class="fa fa-cart-plus"></i> 发报告单</button>
                        <button type="button" class="layui-btn layui-btn-xs" onclick="dropdown(this)">操作 <span class="caret"></span></button>
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            <li>
                                <a href="javascript:void(0);" onclick="$eb.createModalFrame('{{d.nickname}}-订单详情','{:Url('order_info')}?oid={{d.id}}')">
                            ...
                            <li>
                                <a  href="javascript:void(0);" onclick="$eb.createModalFrame('上传报告单','{:Url('edit_report_card')}?id={{d.id}}',{w:700,h:800})">
                                    <i class="fa fa-motorcycle"></i> 上传报告单
                                </a>
                            </li>
                            <li>
                                <a lay-event='marke' href="javascript:void(0);" >
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            ...
                            <li>
                                <a  href="javascript:void(0);" onclick="$eb.createModalFrame('送报告单','{:Url('delivery')}?id={{d.id}}',{w:400,h:300})">
                                    <i class="fa fa-motorcycle"></i> 送报告单
                                </a>
                            </li>
                            <li>
                                <a  href="javascript:void(0);" onclick="$eb.createModalFrame('上传报告单','{:Url('edit_report_card')}?id={{d.id}}',{w:700,h:800})">
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            ...
                            <li>
                                <a  href="javascript:void(0);" class="" onclick="$eb.createModalFrame('上传报告单','{:Url('edit_report_card')}?id={{d.id}}')">
                                    <i class="fa fa-motorcycle"></i> 上传报告单
                                </a>
                            </li>
                            ...
                            {{# } }}
                            {{#  if(d.delivery_type == 'send'){ }}
                            <li>
                                <a lay-event='danger' href="javascript:void(0);">
                                    <i class="fa fa-cart-arrow-down"></i> 已签收
                                </a>
                            </li>
                            {{# } }}
                            {{#  if(d.pay_price != d.refund_price){ }}
    ...
    require(['vue'],function(Vue) {
        new Vue({
            ...
            data: {
                ...
                orderStatus: [
                    {name: '全部', value: ''},
                    {name: '待支付', value: 0,count:orderCount.wz},
                    {name: '待预约', value: 1,count:orderCount.wf,class:true},
                    {name: '待体检', value: 2,count:orderCount.ds},
